...
def data_writer():
    ...
    ingredients = [["Tomaten"], ["Kaas", True, False, False], ["Rosbief", False, False, True], ["Gorgonzola", True, False, False], ["Paprika", True, True, True], ["Artisjokken", True, True, True], ["Rundvlees hamburger", False, False, False], ["Sla", True, True, True], ["Rode ui", True, True, True], ["Augurk", True, True, True], ["Zaika Burgersaus", True, False, False], ["Pulled Chicken", False, False, False], ["Cheddar", True, False, False], ["Aardappel", True, True, True]] 
